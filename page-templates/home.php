...
<div class="container-fluid banner-wrapper">
	...
	<div class="banner">
		<h1>Probably The Greatest Web Hosting. Ever.</h1>
		<h5>What We're Trying To Say Is, It's Web Hosting Made Easy.</h5>
		<div class="banner-btn-wrapper">
			<a href="<?php echo ROOT_URL; ?>/signup" class="btn btn-purple-1">Join Today</a>
			<a href="#services" class="btn btn-inverse-purple-1">Learn More</a>
		</div>
	</div>
</div>
